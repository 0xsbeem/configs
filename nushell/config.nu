...
alias ew = sudo watch -cn -1 genlop -ci
alias updateall = sudo emerge --ask --verbose --update --deep --changed-use @world
alias cleandeps = sudo emerge --ask --verbose --depclean @world
alias pnpm = pnpm-bin
alias esync = sudo emaint sync -a

# Golang development aliases
alias dlvserver = dlv debug --headless --api-version=2 --listen=127.0.0.1:43000 
alias dlvclient = dlv connect 127.0.0.1:43000
